...
$(function() {
    ...
    var options = {
        center: {lat: 43.594283, lng: -79.668553}, // L5R, Mississauga
...
function addMarker(place)
{
   ...
   var label = place.place_name + "," + place.postal_code;
   
   // from https://developers.google.com/maps/documentation/javascript/symbols
   var icon = {
   ...
   ({
       position: markerLoc,
       map: map,
       labelContent: label.substring(0, 50),
       icon: icon
   });
   
   marker.addListener('click', function() 
   {
       showInfo(marker); // loading wheel gif 
       ...
       .done(function(data, textStatus, jqXHR)
       {
           ...
           {
               var list = "<ul>";
               var tpl = _.template("<li><a href = '<%- link %>' target = '_blank'><%- title %></a></li>");
